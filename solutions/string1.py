...
# Given a string, return true if "bad" appears starting at index 0 or 1 in the string, such as with "badxxx" or "xbadxx" but not "xxbadxx". The 
# string may be any length, including 0. Note: use == to compare 2 strings.
def has_bad(str):
