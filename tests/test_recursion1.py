...
class TestRecursion1(unittest.TestCase):
    ...
    def test_count_hi2(self):
        self.assertEqual(recursion1.count_hi2('ahixhi'), 1) 
        self.assertEqual(recursion1.count_hi2('ahibhi'), 2) 
        self.assertEqual(recursion1.count_hi2('xhixhi'), 0) 
        self.assertEqual(recursion1.count_hi2('hixhi'), 1) 
        self.assertEqual(recursion1.count_hi2('hixhhi'), 2) 
        self.assertEqual(recursion1.count_hi2('hihihi'), 3) 
        self.assertEqual(recursion1.count_hi2('hihihix'), 3) 
        self.assertEqual(recursion1.count_hi2('xhihihix'), 2) 
        self.assertEqual(recursion1.count_hi2('xxhi'), 0) 
        self.assertEqual(recursion1.count_hi2('hixxhi'), 1) 
        self.assertEqual(recursion1.count_hi2('hi'), 1) 
        self.assertEqual(recursion1.count_hi2('xxxx'), 0) 
        self.assertEqual(recursion1.count_hi2('h'), 0) 
        self.assertEqual(recursion1.count_hi2('x'), 0) 
        self.assertEqual(recursion1.count_hi2(''), 0) 
        self.assertEqual(recursion1.count_hi2('Hellohi'), 1) 
