...
def scores_average(scores):
    ...
    To practice decomposition, write a separate helper method average(scores, start, end)
    which computes the average of the elements between indexes start..end. Call your helper 
    method twice to implement scores_average().  Normally you would compute averages with 
