...
def split_array(nums):
    ...
    helper function that takes whatever arguments you like, and make the initial call to your recursive 
...
def split_odd_10(nums):
    ...
    and make the initial call to your recursive helper from split_odd_10(). (No loops needed.)
    """
    def is_odd_10(a, b):
        return (a % 10 == 0 and b % 2 == 1) or (b % 10 == 0 and a % 2 == 1)
